...
Target project: [`lesson-23/python-hw23`](../lesson-23/python-hw23) (text analyzer + address book from lesson 23).
...
| `APP_DIR` | `lesson-23/python-hw23` | path to the source code |
